          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'] . '?id=' . $_GET['id']); ?>" method="POST">
            ...
            <div class="input-group mb-4">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" name="note_id" id="floatingInputGroup1" value="<?= $_GET['id']; ?>" placeholder="id" style="font-size: 20px" disabled>
            ...
            <div class="input-group mb-4">
              ...
              <div class="form-floating">
                <input type="text" class="form-control" name="user_id" id="floatingInputGroup1" placeholder="userId" value="<?= $notesRow['user_id']; ?>" style="font-size: 20px" disabled>
